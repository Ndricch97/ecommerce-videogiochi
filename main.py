...
# - Inserimento di un prodotto all'interno di un'ordine (OrdineProdotto)
...
# - Inserimento di un prodotto all'interno di una wishlist (WishlistProdotto)
...
# - Lista di prodotti all'interno di un ordine (OrdineProdotto)
...
# - Lista di prodotti all'interno di una wishlist (WhislistProdotto)
...
def elimina_wishlist(id_wishlist):
 ...
 # - Rimozione di un prodotto all'interno di un'ordine (OrdineProdotto)
def rimuovi_prodotto_da_ordine(id_ordine, id_prodotto):
 ...
 # - Rimozione di un prodotto all'interno di una wishlist (WishlistProdotto)
